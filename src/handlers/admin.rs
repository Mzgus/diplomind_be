...
pub async fn deactivate_user(
    ...
    println!("ADMIN ACTION: User {} deactivated by admin {}", user_id, auth_user.0.user_email);
...
pub async fn activate_user(
    ...
    println!("ADMIN ACTION: User {} activated by admin {}", user_id, auth_user.0.user_email);
...
pub async fn revoke_all_sessions(
    ...
    println!("SECURITY: All {} sessions revoked by admin {}", tokens_revoked, auth_user.0.user_email);
